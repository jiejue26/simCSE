...
def parse_args():
    ...
    parser.add_argument("--train_file", type=str, default=r".\data\gsp.txt")
    parser.add_argument("--pretrained", type=str, default=r".\pre_model\bert-wwm")
    parser.add_argument("--model_out", type=str, default=r".\model")
    ...
    parser.add_argument("--display_interval", type=int, default=2, help="display interval")
    ...
    for epoch_idx in range(args.epochs):
        for data in tqdm(dl):
            ...
            if batch_idx % args.display_interval == 0:
                ...
                torch.save(model.state_dict(), ".\model\gsp-epoch-{0}.pt".format(epoch_idx))
            #if batch_idx % args.save_interval == 0:
               # torch.save(model.state_dict(), ".\model\gsp-epoch-{0}-batch_{1}.pt".format(epoch_idx, batch_idx))
